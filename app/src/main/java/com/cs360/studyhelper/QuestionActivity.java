 ...
 * CS 350
 *
 * @description QuestionActivity class is started when the user selects a subject from the subject
 * screen. SubjectActivity passes the selected subject in an intent to QuestionActivity so the
 * questions that match the subject can be displayed.
 */
...
public class QuestionActivity extends AppCompatActivity {
    ...
    public void addQuestionButtonClick(View view) {
        // Respond to button click and add question
        addQuestion();
    }

    public void answerButtonClick(View view) {
        // Respond to button click to make the answer visible or not
        toggleAnswerVisibility();
    }
