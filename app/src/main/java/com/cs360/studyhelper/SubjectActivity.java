 ...
 * CS 350
 *
 * @description The controller class SubjectActivity controls the subject screen.
 */
...
public class SubjectActivity extends AppCompatActivity
     ...
     * @return List<Subject> The list of subjects ordered in descneding order by update time.
     */
    private List<Subject> loadSubjects() {
        ...
        switch (Integer.parseInt(order)) {
            case 0: return mStudyDb.getSubjects(StudyDatabase.SubjectSortOrder.eALPHABETIC);
            case 1: return mStudyDb.getSubjects(StudyDatabase.SubjectSortOrder.eUPDATE_DESC);
            default: return mStudyDb.getSubjects(StudyDatabase.SubjectSortOrder.eUPDATE_ASC);
        }
    }
    ...
    /**
     * Private class to describe the item view
     */
    ...
    /**
     * Private class that will shows views of items in a data set.
     */
